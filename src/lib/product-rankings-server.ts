...
const productCopyPresets: ProductCopyPreset[] = [
  {
    matches: ["kensui", "突っ張り式懸垂バー", "突っ張り式 懸垂バー"],
    summary: "天井と床で突っ張って設置する、設置面積18cm×18cmの懸垂バーです。",
    bestFor: "チンニングスタンドを置くスペースがなく、工事や穴あけをせずに自宅へ懸垂環境を作りたい人",
    pros: ["設置面積が手のひらサイズで、従来型スタンドの約1/25のスペースで済む", "特許技術の85度傾斜で、ぶら下がっても手前に倒れにくい", "工事不要の突っ張り式で、ハンドルによってはディップスにも使える"],
    cons: ["天井の強度確認が必須で、突っ張れない天井には設置できない", "耐荷重130kgのため、加重懸垂で追い込みたい人は総重量を確認したい"],
  },
  {
